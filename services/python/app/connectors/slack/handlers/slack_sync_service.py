"""Slack synchronization service following Gmail/Drive pattern"""
...
from app.connectors.slack.handlers.slack_data_handler import SlackDataHandler
...
class SlackSyncEnterpriseService(BaseSlackSyncService):
    ...
    async def resync_workspace(self, org_id) -> bool:
        ...
        try:
            ...
            if last_shutdown and (current_time - last_shutdown) > 300:  # 5 minutes
