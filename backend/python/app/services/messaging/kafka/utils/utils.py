...
async def create_producer_config(app_container: AppContainer) -> KafkaProducerConfig:
...
async def create_entity_kafka_consumer_config(app_container: AppContainer) -> KafkaConsumerConfig:
...
async def create_sync_kafka_consumer_config(app_container: AppContainer) -> KafkaConsumerConfig:
...
async def create_record_kafka_consumer_config(app_container: AppContainer) -> KafkaConsumerConfig:
...
async def create_aiconfig_kafka_consumer_config(app_container: AppContainer) -> KafkaConsumerConfig:
...
async def create_entity_message_handler(app_container: AppContainer) -> Callable[[Dict[str, Any]], Awaitable[bool]]:
...
async def create_record_message_handler(app_container: AppContainer) -> Callable[[Dict[str, Any]], Awaitable[bool]]:
    """Create a message handler for entity events"""
    logger = app_container.logger()
...
async def create_sync_message_handler(app_container: AppContainer) -> Callable[[Dict[str, Any]], Awaitable[bool]]:
...
async def create_aiconfig_message_handler(app_container: AppContainer) -> Callable[[Dict[str, Any]], Awaitable[bool]]:
