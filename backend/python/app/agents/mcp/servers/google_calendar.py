...
#             label="Google OAuth",
#             help_text=(
#                 "Enable the Calendar MCP API (calendarmcp.googleapis.com) on your Google Cloud "
#                 "project, then create an OAuth client ID and provide it below — Google does not "
