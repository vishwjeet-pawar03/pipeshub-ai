...
class GoogleDrive:
    ...
    @tool(
        ...
        short_description="Get the list of files in Google Drive",
        description="Get the list of files in a Google Drive folder with pagination support.",
        parameters=[
            ToolParameter(
                name="folder_id",
    ...
    async def get_files_list(self, folder_id: Optional[str] = None, page_token: Optional[str] = None) -> tuple[bool, str]:
    ...
    @tool(
        ...
        short_description="Create a folder in Google Drive",
    ...
    @tool(
        path="/tools/drive/upload_file",
        short_description="Upload a file to Google Drive",
        description="Upload a file to Google Drive with an optional target folder.",
        parameters=[
            ToolParameter(
                name="file_name",
                type=ParameterType.STRING,
    ...
    async def upload_file(self, file_name: str, file_content: BinaryIO, folder_id: Optional[str] = None) -> tuple[bool, str]:
    ...
    @tool(
        path="/tools/drive/download_file",
        short_description="Download a file from Google Drive",
    ...
    async def download_file(self, file_id: str) -> tuple[bool, Optional[BinaryIO]]:
    ...
    @tool(
        path="/tools/drive/delete_file",
        short_description="Delete a file from Google Drive",
        ...
        tags=[Tag(key="category", value="file_management"), Tag(key="type", value="delete")],
    )
    ...
    @tool(
        ...
        short_description="Get details of a file from Google Drive",
        description="Get the metadata and details of a file from Google Drive by its file ID.",
        parameters=[
            ToolParameter(
                name="file_id",
                type=ParameterType.STRING,
    ...
    async def get_file_details(self, file_id: str) -> tuple[bool, str]:
