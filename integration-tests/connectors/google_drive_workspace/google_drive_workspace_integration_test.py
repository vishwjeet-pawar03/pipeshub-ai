...
class TestDriveWorkspaceFolderFilter:
    ...
    async def test_tc_ff_011_in_scope_parent_change_updates_parent(
        ...
        seed_id = drive_workspace_connector["seed_folder_id"]
        nested_id = drive_workspace_connector["nested_folder_id"]
        new_file_id = drive_workspace_connector["new_file_id"]
    ...
    async def test_tc_ff_012_multi_seed_syncs_oos_sibling(
        ...
        drive_workspace_connector["scoped_after_multi_seed"] = scoped_after
        ...
        await connector_assertions.assert_record_exists(
            ...
            RecordAssertion(
                ...
                record_name=drive_workspace_connector["oos_file_name"],
    ...
    async def test_tc_ff_013_narrow_folder_ids_to_nested(
        ...
        scoped_before = int(
            drive_workspace_connector.get("scoped_after_multi_seed")
        ...
        drive_workspace_connector["scoped_after_narrow"] = scoped_after
    ...
    async def test_tc_ff_014_widen_folder_ids_to_seed(
        ...
        seed_id = drive_workspace_connector["seed_folder_id"]
        leave_file_id = drive_workspace_connector["leave_file_id"]
        leave_file_name = drive_workspace_connector["leave_file_name"]

        scoped_narrow = int(
            drive_workspace_connector.get("scoped_after_narrow")
            or await graph_provider.count_records(connector_id, scoped=True)
        )
        scoped_multi = int(
            drive_workspace_connector.get("scoped_after_multi_seed") or 10**9
        )
        ...
        drive_workspace_connector["scoped_after_widen"] = scoped_after
